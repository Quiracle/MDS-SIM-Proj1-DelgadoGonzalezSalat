...
Boxplot(df$incidencerate)
length(Boxplot(df$incidencerate, id = list(n=Inf), plot=FALSE))
...
Boxplot(df$medincome)
length(Boxplot(df$medincome, id = list(n=Inf), plot=FALSE))
...
length(Boxplot(df$percentmarried, id = list(n=Inf), plot=FALSE))
...
Boxplot(df$pctpubliccoveragealone)
length(Boxplot(df$pctpubliccoveragealone, id = list(n=Inf), plot=FALSE))
...
Boxplot(df$pctblack)
length(Boxplot(df$pctblack, id = list(n=Inf), plot=FALSE))
